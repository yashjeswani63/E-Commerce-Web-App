<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="User.aspx.cs" Inherits="E_Commerce.User1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <p style="text-align: center; font-family: 'Trebuchet MS', 'Lucida Sans Unicode', 'Lucida Grande', 'Lucida Sans', Arial, sans-serif; font-size: large; background-color: #FFFFFF; background-image: url('Banner.jpg');" class="auto-style10">
     &nbsp;
 </p>
         ...
         <table class="auto-style11">
             ...
             <tr>
                 <td class="auto-style8">
                     <asp:Button ID="Button1" runat="server" Text="Buy Now" CommandName="BuyNow" CommandArgument='<%# Eval("product_id") %>' />
                 </td>
                 <td class="auto-style8">
                     <asp:Button ID="Button3" runat="server" Text="Add To Cart" CommandName="AddtoCart" CommandArgument='<%# Eval("product_id") %>'  />
                 </td>
             </tr>
         </table>
